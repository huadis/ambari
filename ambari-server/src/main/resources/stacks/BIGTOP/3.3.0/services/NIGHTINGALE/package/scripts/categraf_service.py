...
def categraf_service(name, action="start", upgrade_type=None):
    ...
    if name == "server":
        ...
        cmd_start = f"cd {params.categraf_home};nohup {params.categraf_home}/categraf --start > {params.categraf_log_dir}/categraf.log 2>&1 < /dev/null &"
        cmd_stop = f"cd {params.categraf_home};{params.categraf_home}/categraf --stop"
