...
from dataease_env import dataease_env

class DataEaseService(Script):
    ...
    def status(self, env):
        import params
        env.set_params(params)
        check_process_status(params.dataease_pid_dir + "/" + params.dataease_pid_filename)
